...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("iMWritingDuo Nerd Font"
                               :size 14.0
                               :weight normal
                               :width normal)
...
before packages are loaded."
  ...
  (setq org-archive-location
        '"~/Documents/Org/Archived/%s_archive::")
  (setq org-default-notes-file
        '"~/Documents/Org/TODO.org")
  (setq org-capture-templates
        '(("t" "TODO" entry (file+headline "~/Documents/Org/TODO.org" "Tasks")
           "* TODO %?\n  %u\n  %i\n  %a")
          ("r" "Read Later" entry (file "~/Documents/Org/Reflection/TOREAD.org")
           "* WISHLIST %?\n  %u\n  %i\n  %a")
          ("p" "Prayer" entry (file "~/Documents/Org/Reflection/Prayers.org")
           "* %?\n  %i\n  %a\n  - Entered: %T")
